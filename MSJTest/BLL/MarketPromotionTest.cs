    ...
    public class MarketPromotionTest
    {
        ...
        public void TestMethod1()
        {
          ...
          var result=  marketPromotion.Get();
            ...
            Assert.AreEqual(462, result[1].B.Agent4);
            Assert.AreEqual(0.52m, Decimal.Round(result[1].AX.M2, 2));
            Assert.AreEqual(0.33m, decimal.Round(result[1].BP.M2, 2));
            Assert.AreEqual(768, result[2].B.M);
            Assert.AreEqual(800, result[2].B.Agent4);
            Assert.AreEqual(0.6m, Decimal.Round(result[2].AX.M2, 2));
            Assert.AreEqual(0.33m, decimal.Round(result[2].BP.M2, 2));
        }
    }
}
